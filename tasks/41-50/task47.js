...
const inputPosts = [
    {title: 'Как быстро выучить JavaScript?', postId: 3421, comments: 25},
    {title: 'Где используется JavaScript?', postId: 5216, comments: 3},
    {title: 'Какая разница между React и Angular?', postId: 8135, comments: 12},
]
